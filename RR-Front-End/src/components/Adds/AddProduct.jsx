...
export const AddProduct = ({ getProducts }) => {
    const title = 'Agregar Materiales'
    ...
    const saveProduct = async () => {
        try {
            const { data } = await axios.post('http://localhost:3400/product/saveProduct', form, { headers: headers })
            Swal.fire({
                title: `${data.message}`,
                icon: "success",
            })
                    ...
                    <div className="modal-content">
                        ...
                        <div className='modal-body'>
                            ...
                            <div className='modal-footer'>
                                <button onClick={() => saveProduct()} type="submit" className="btn btn-primary">Agregar Material</button>
